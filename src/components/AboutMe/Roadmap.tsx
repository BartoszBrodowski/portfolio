...
const Roadmap: FunctionComponent = () => {
    ...
    return (  
        <div className="flex flex-col justify-center items-center h-4/5 absolute hidden md:block">
            ...
            <div className="flex justify-center h-full relative">
                ...
                <Tooltip delay={0} closeDelay={0} content="Click to know more" placement="left">
                    <div className="bg-main-green w-4 h-4 absolute rounded-full border border-4 top-1/4 -translate-y-1/2 hover:scale-150 transition-all hover:cursor-pointer animate-button-float" onClick={onOpen}>
                    </div>
                </Tooltip>
                <UniversityModal isOpen={isOpen} onOpen={onOpen} onClose={onClose} />
                <div className="bg-main-green w-4 h-4 absolute rounded-full border border-4 top-3/4 -translate-y-1/2 hover:scale-150 transition-all">
